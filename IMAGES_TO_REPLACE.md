# Images to replace later

The overlay includes neutral placeholders so the site can build before real figures are added.
...
- `assets/img/project_geometry_reference.png`
  - best: B-rep vs STL comparison or signed path-length difference map
- `assets/img/project_variation_propagation.png`
  - best: projection-wise variation plot or reconstruction/measurand result
- `assets/img/project_medical_ct.png`
...
After you upload real images with the same filenames, no Markdown edits are required.
